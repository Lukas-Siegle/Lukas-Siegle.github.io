<script lang="ts">
	...
	<ScrollArea class="rounded-md border bg-card">
		<div class="p-6">
			<h4 class="mb-6 text-xl font-semibold">Technologies I Regularly Use and Have Experience With</h4>
			<div class="grid grid-flow-row grid-cols-1 md:grid-cols-2">
				{#each technologies_current as technology}
					<div class="flex flex-col justify-center">
						<div
							class="flex w-[95%] items-center space-x-4 rounded-lg bg-card p-3 transition-colors hover:bg-accent mb-2"
						>
							<img
						...
						<Separator class="w-[95%] mb-2" />
					</div>
				{/each}
			</div>
		</div>
		<div class="p-6">
			<h4 class="mb-6 text-xl font-semibold">Tools and Technologies I've Used or Occasionally Utilize</h4>
